...
#saveRDS(spotify, file = "spotifyRAW.rds")
```
...
7. Save our dataframe into an RDS file
```{r}
saveRDS(spotify, file = "Top200StreamsUSA2018RAW.rds")#Function to write a single R object to a file
```
